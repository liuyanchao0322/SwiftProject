...
class HQAnimator: NSObject {
    
    // MARK: - Public Properties
    public var duration: TimeInterval = 2.0
    public var label: HQAnimatedLabel? {
        didSet {
    ...
    private(set) var animationType: HQAnimationType
    ...
    // MARK: - Init
    convenience init(animationType: HQAnimationType, duration:TimeInterval) {
        self.init()
